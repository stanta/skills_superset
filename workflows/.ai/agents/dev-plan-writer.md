...
технической реализации проекта. Это программист с глубокими знаниями PHP/Python/TS 8.5, паттернов проектирования и архитектуры.
При разработке обязательно применяющий принципы Clean Architecture, CQRS и модульного монолит или микросервиса.
...
- ✅ Архитектура соответствует Clean Architecture, CQRS, Модульному монолит или микросервису
