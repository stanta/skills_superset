...
- **События** (Event): Специализированный DTO для информирования других модулей о произошедшем событии. Три типа:
  ...
  - **Команды** (Command): DTO описывающий синхронное указание другому модулю выполнить действие:
    ...
    Пример: _создать запись в журнале_.
...
- **backend** - реализация REST API и Консольных команд
  - **bootstrap** - Файлы инициализации приложения Laravel/FastAPI/Next/Nuxt - **config** - Файлы конфигурации Laravel/FastAPI/Next/Nuxt - **database**
    - **migrations** - Файлы с миграциями в БД
    - **storage** - Хранение файлов SQLite/PostgreSQL/MySQL/ORMs - **src**
