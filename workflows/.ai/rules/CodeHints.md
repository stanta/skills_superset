...
- Используй публичные readonly свойства в \_\_construct вместо геттеров, когда нет необходимости в дополнительной логике.
...
Для связи интерфейсов и их реализаций в контейнере зависимостей Laravel/FastAPI/Next/Nuxt используйте метод `bind`:
