...
Реализация модуля Currency для конвертации валют с использованием Clean Architecture, CQRS и модульного монолит или микросервиса.

## Архитектурное решение

### Выбранный подход

**Архитектура**: Clean Architecture + CQRS + Модульный монолит или микросервис
