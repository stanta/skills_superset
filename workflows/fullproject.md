...
- **Kilo Code workflows** размещаются в папке `.kilocode/workflows/` и имеют имена `*.md`.
  - Вызов: `/workflow-name` соответствует файлу `.kilocode/workflows/workflow-name.md`.
  - В этом репозитории описания команд лежат в `.ai/commands/`.
    Команды `/ra-*` ссылаются на соответствующие документы:
    `/ra-create-epic` → `./.ai/commands/ra-create-epic.md`, и т. д.
...
**Пример полного цикла:** См. [Quick Start Guide с примером "Калькулятор валют"](./.ai/examples/QuickStartGuide.md#пример-калькулятор-валют)
...
### Системный аналитик + PHP/Python/TS Техлид
...
Если задача не большая, то [создавать эпик не обязательно](./.ai/examples/FAQ.md#когда-создавать-эпик-а-когда-сразу-фичу).
...
- **[Architecture.md](./.ai/rules/Architecture.md)** - правила архитектуры: Clean Architecture, CQRS, модульный монолит или микросервис
- **[ArchitecturalCompromises.md](./.ai/rules/ArchitecturalCompromises.md)** - осознанные компромиссы и их обоснование
- **[CodeHints.md](./.ai/rules/CodeHints.md)** - рекомендации по работе с PHP/Python/TS в проекте
- **[CodeStyle.md](./.ai/rules/CodeStyle.md)** - принятый стиль кода
- **[TestingHints.md](./.ai/rules/TestingHints.md)** - рекомендации по написанию тестов
- **[FeatureWorkflow.md](./.ai/rules/FeatureWorkflow.md)** - workflow добавления новых фич

### Быстрый старт и примеры

- **[Quick Start Guide](./.ai/examples/QuickStartGuide.md)** - пошаговое руководство с полным примером
- **[Quick Start Checklist](./.ai/examples/QuickStartChecklist.md)** - краткий чек-лист
- **[FAQ](./.ai/examples/FAQ.md)** - часто задаваемые вопросы и решения проблем
- **[Примеры документов](./.ai/examples/filled-examples/)** - EpicSummary, Spec, TaskSummary

### Агенты и команды

- **[Документация агентов](./.ai/agents/)** - детальное описание всех AI-агентов
- **[Документация команд](./.ai/commands/)** - алгоритмы работы команд
- **[Шаблоны](./.ai/agents/Template/)** - шаблоны для всех типов документов
...
1. Проверьте [FAQ](./.ai/examples/FAQ.md)
2. Изучите [примеры](./.ai/examples/filled-examples/)
3. Перечитайте [Quick Start Guide](./.ai/examples/QuickStartGuide.md)
