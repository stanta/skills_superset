...
description: >
  Use this normal Agent Skill first for web navigation, browser verification, scraping and browser testing. Decompose the request and select concrete atomic skills using ordinary file search and its child catalog. Typical requests: browser task, web scraping, browser QA.
---
...
- browser task: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- web scraping: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- browser QA: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
