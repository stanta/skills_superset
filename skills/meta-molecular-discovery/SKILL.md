...
description: >
  Use this normal Agent Skill first for molecular chemistry, proteins, drug screening and structural biology. Decompose the request and select concrete atomic skills using ordinary file search and its child catalog. Typical requests: protein structure, ligand screening, molecular design.
---
...
- protein structure: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- ligand screening: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- molecular design: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
