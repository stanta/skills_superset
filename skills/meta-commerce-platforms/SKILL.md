...
description: >
  Use this normal Agent Skill first for Shopify, ecommerce, storefronts, merchant services and checkout. Decompose the request and select concrete atomic skills using ordinary file search and its child catalog. Typical requests: Shopify storefront, checkout, merchant tools.
---
...
- Shopify storefront: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- checkout: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- merchant tools: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
