# Children of meta-web3-blockchain

4 atomic skills. Search **in this Markdown file** for the required topic or name; no script is involved.
...
- **ton-smart-contracts-specialist** — Use when working on TON smart contracts, Tact/FunC code, opcode design, contract wrappers, or contract-to-app integration boundaries in this workspace. — `../../../atomic-skills/ton-smart-contracts-specialist/SKILL.md`
