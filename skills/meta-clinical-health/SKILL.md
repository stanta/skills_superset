...
description: >
  Use this normal Agent Skill first for clinical evidence, health research, medical records and translational science. Decompose the request and select concrete atomic skills using ordinary file search and its child catalog. Typical requests: clinical literature, health datasets, medical workflows.
---
...
- clinical literature: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- health datasets: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
- medical workflows: select a matching Start skill from `references/members.md`; add Support or Check only if the task requires it.
